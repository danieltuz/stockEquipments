                        ...
                        <div class="row">
                            <div class="offset-xxl-2 col-xxl-8">
                                ...
                                <div class="form-group fv-plugins-icon-container has-success">
                                    ...
                                    <textarea class="form-control" rows="5" disabled>{{ $equipos[0]['obs_baja'] }}</textarea>
                                </div>
                                <!--end::Input-->
                                ...
                                <div class="form-group fv-plugins-icon-container has-success">
                                    ...
                                    <textarea class="form-control" rows="5" disabled >{{ $equipos[0]['descripcion'] }}</textarea>
                                </div>
                                <!--end::Input-->

                                <div class="text-center">
                                    <a href="javascript:void(0);" onclick="cargarformulario(14,0,1);" class="btn btn-primary">Cerrar</a>
                                </div>
                                {{----}}
                            </div>
                            <!--end: Wizard-->
