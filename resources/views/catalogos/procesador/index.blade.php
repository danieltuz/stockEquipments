    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="javascript:;" class="btn btn-primary font-weight-bolder" onclick="cargarformulario(9.2,0,2);">
...
<script>
    ...
    $('#kt_datatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('catalogos.procesador.getProcesador') }}",
        "columns":[
            { "data": "id" },
            { "data": "nombre" ,className: "text-left",},
            { "data": "socket" ,className: "text-left",},
