    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="javascript:;" class="btn btn-primary font-weight-bolder" onclick="cargarformulario(2.2,0,2);">
        ...
        <div class="card-body">
            ...
            <table class="table table-hover" id="kt_datatable">
                ...
                <tr>
                    ...
                    <td style="width: 400px" class="text-left">
                        <b>SubDirección</b>
                        <select class="form-control datatable-input" data-col-index="0" id="subdirecciones">
                            <option value="">Seleccione</option>
                        </select>
                    </td>
...
<script>
    ...
    var KTDatatablesSearchOptionsAdvancedSearch = function() {
        ...
        var initTable1 = function() {
            ...
            var table = $('#kt_datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/catalogos/subdireccion/getSubDireccion',
                    type: 'GET',
                },
                columnDefs:[{
                    targets: "_all",
    ...
    function cargarDirecciones() {
        ...
        url="/catalogos/subdireccion/getDireccion";
    ...
    function cargarSubdirecciones(select) {
        ...
        if (!isNaN(parseInt(value))) {
            url="/catalogos/subdireccion/"+value+"/getSubdireccionSeleccion";
            $.get(url, function (response) {
                if (response.status == 200) {
