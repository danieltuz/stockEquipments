    ...
    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="input-group">
                        <select name="tipoEquipo_id_catalogo" id="tipoEquipo_id_catalogo" class="form-control" disabled>
                            <option value="Seleccione" selected>Seleccione</option>
                            <option {{ $equipo=="CPU" ? "selected" : "" }}>CPU</option>
                            <option {{ $equipo=="MONITOR" ? "selected" : "" }}>MONITOR</option>
                        </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="input-group">
                        <select name="marcas_id_catalogo" id="marcas_id_catalogo" class="form-control" disabled>
                            @foreach($marcas as $marca)
                                <option {{ $modelos->marcas_id==$marca->id ? "selected" : "" }}
...
<script>
    ...
    $("#action_button").on('click', function() {
        ...
        debugger;
        $.ajax({
            url: '/catalogos/modelo/destroy/' +  id,
            method: 'get',
