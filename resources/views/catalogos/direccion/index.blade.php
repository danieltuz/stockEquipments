    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="javascript:;" class="btn btn-primary font-weight-bolder" onclick="cargarformulario(1.2,0,2);">
        ...
        <div class="card-body">
            ...
            <table class="table table-hover" id="kt_datatable" style="margin-top: 13px !important">
                ...
                <tr>
                    ...
                    <td style="width: 80%" class="text-left"><b>Dirección</b></td>
                    <td style="width: 15%" class="text-center"><b>Acciones</b></td>
                </tr>
                </thead>
            </table>
            <!--end: Datatable-->
...
<script>
    ...
    $('#kt_datatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('catalogos.direccion.getDireccion') }}",
        "columns":[
            { "data": "id" },
