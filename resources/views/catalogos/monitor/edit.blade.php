...
<div class="container">
    ...
    <div class="card card-custom">
        <div class="card-header">
			...
			<i class="icon-xl fa fa-desktop text-primary"></i>
                </span>
        ...
        <div class="card-body">
            <div class="form-group row">
                <label class="col-form-label text-right col-lg-3 col-sm-12"
                       id="bk_nombre_tipo_monitor_catalogo">Tipo de Monitor
                </label>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="input-group">
                        <input type="text"
                               class="form-control"
                               id="nombre_tipo_monitor_catalogo"
                               value="{{ $monitor }}"
                               placeholder="Escriba un Tipo de Monitor"/>

                        <span class="input-group-text">
                               <i class="fa fa-desktop text-primary mr-0"></i>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-9 ml-lg-auto">
                    <a href="javascript:void(0);" onclick="cargarformulario(8,0,2);" class="btn btn-secondary">Cancelar</a>
...
<script>
    ...
    $("#action_button").on('click', function() {
        ...
        if (errores > 0 ){
            ...
            $.ajax({
                url: '/catalogos/monitor/update',
                method: 'post',
                data: {
                    '_token': CSRF_TOKEN,
                    'id': id,
                    'nombre': $('#nombre_tipo_monitor_catalogo').val()
                },
