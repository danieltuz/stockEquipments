...
<div class="container">
    ...
    <div class="card card-custom">
        <div class="card-header">
			...
			<i class="icon-xl fa fa-tag text-primary"></i>
                </span>
        ...
        <div class="card-body">
            <div class="form-group row">
                <label class="col-form-label text-right col-lg-3 col-sm-12"
                       id="bk_nombre_marca_catalogo">Nombre de la Marca
                </label>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="input-group">
                        <input type="text"
                               ...
                               placeholder="Escriba el Nombre de Una Marca"/>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-9 ml-lg-auto">
                    <a href="javascript:void(0);" onclick="cargarformulario(6,0,2);" class="btn btn-secondary">Cancelar</a>
        ...
        if (errores > 0 ){
            ...
            $('#formModal').modal('show');
                ...
                $.ajax({
                    type: 'POST',
                    '_token': CSRF_TOKEN,
                    url: '/catalogos/marca/store',
                    data: {
                        '_token' : $('input[name=_token]').val(),
                        'nombre' : $('#nombre_marca_catalogo').val()
                    },
